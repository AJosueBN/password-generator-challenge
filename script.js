...
var length = prompt("How much length do you want your password to be?  Note:Between 8-128 characters and within the next criteria choose at least ONE character type")
console.log(length)
